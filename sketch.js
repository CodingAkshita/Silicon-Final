...
function preload() {
  ...
  font = loadFont("/fontsG/Pushster-Regular.ttf")
...
function draw() {
  ...
  if (gameState === "about") {
    ...
    text("\n  The Game Is About Healthy Eating Habits.", (popbox.x- (popbox.width/1.3)), 60)
    text("\n\n Level 1", (popbox.x- (popbox.width/7)), 62)
    text("\n\n1) The player jumps if you press the Up \n  Arrow Key.", (popbox.x- (popbox.width/1.36)), 100)
    text("\n\n\n2) Try your best to make the player eat \n the healthy food rather than the junk.", (popbox.x- (popbox.width/1.4)), 150)
    text("\n\n\nLevel 2", (popbox.x- (popbox.width/7)), 245)
    text("\n\n  You have the power to control the player \n    with the help of your mouse. Try your \n    best not to touch the bacteria. \n         Your health is your real wealth.", (popbox.x- (popbox.width/1.36)), 330)
  }
  ...
  if (gameState === "know") {
    ...
    text("\n  1) Processed food is designed to get you addicted.",(popbox.x-(popbox.width/1.3)), 55)
    text("\n\n  2) There are insect secretions in your candy.",(popbox.x-(popbox.width/1.3)), 60)
    text("\n\n\n  3) Natural Flavors aren't really that natural.",(popbox.x-(popbox.width/1.3)), 65) 
    text("\n\n\n\n   4) Pizza Hut uses over 300 million pounds of\n      cheese per year.",(popbox.x-(popbox.width/1.3)), 70)  
    text("\n\n\n\n\n\n    5) Cancer-causing chemicals keep your meat\n       looking wonderful.",(popbox.x-(popbox.width/1.3)), 75) 
    text("\n\n\n\n\n\n\n\n     6) Junk Foods can cause memory and \n         learning problems.",(popbox.x-(popbox.width/1.3)), 80)   
    text("\n\n\n\n\n\n\n\n\n\n       7) The high fat content in the ice cream\n         actually warms up the body.",(popbox.x-(popbox.width/1.3)), 85)           
